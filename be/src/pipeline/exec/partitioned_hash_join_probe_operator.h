...
class PartitionedHashJoinProbeDependency final : public Dependency {
public:
    using SharedState = PartitionedHashJoinSharedState;
    PartitionedHashJoinProbeDependency(int id, int node_id, QueryContext* query_ctx)
            : Dependency(id, node_id, "PartitionedHashJoinProbeDependency", query_ctx) {}
    ~PartitionedHashJoinProbeDependency() override = default;

    friend class PartitionedHashJoinProbeOperatorX;
};

class PartitionedHashJoinProbeLocalState final
        : public JoinProbeLocalState<PartitionedHashJoinProbeDependency,
