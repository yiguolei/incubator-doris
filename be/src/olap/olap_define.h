...
enum OLAPStatus {
    ...
    OLAP_ERR_REMOTE_STORAGE_NOT_FOUND = -4100,
    OLAP_ERR_REMOTE_META_VERSION_CONFLICT = -4101,
    OLAP_ERR_REMOTE_META_TIMEOUT = -4102,
    OLAP_ERR_REMOTE_META_PARSE_RESP = -4103
};
